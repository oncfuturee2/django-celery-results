...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        FakeAddIndex(
            model_name="chordcounter",
            index=models.Index(
                fields=["group_id"], name="django_cele_group_i_299b0d_idx"
            ),
        ),
        FakeAddIndex(
            model_name="taskresult",
            index=models.Index(
                fields=["task_id"], name="django_cele_task_id_7f8fca_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="taskresult",
        ...
        FakeAddIndex(
            ...
            index=models.Index(
                fields=["group_id"], name="django_cele_group_i_3cddec_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="groupresult",
