...
class TaskResult(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["task_name"], name="django_cele_task_na_08aec9_idx"),
            models.Index(fields=["status"], name="django_cele_status_9b6201_idx"),
            models.Index(fields=["worker"], name="django_cele_worker_d54dd8_idx"),
            models.Index(
                fields=["date_created"], name="django_cele_date_cr_f04a50_idx"
            ),
            models.Index(fields=["date_done"], name="django_cele_date_do_f59aad_idx"),
            models.Index(
...
class ChordCounter(models.Model):
    ...
    count = models.PositiveIntegerField(
        help_text=_(
            "Starts at len(chord header) and decrements after each task is finished"
        )
    )
    ...
    def group_result(self, app=None):
        ...
        return CeleryGroupResult(
            self.group_id,
            [result_from_tuple(r, app=app) for r in json.loads(self.sub_tasks)],
            app=app,
        )
...
class GroupResult(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["date_done"], name="django_cele_date_do_caae0e_idx"),
        ]
