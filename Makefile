...
help:
	...
	@echo "    ruffcheck        - Run Ruff lint checks on the source code."
	@echo "    formatcheck      - Run Ruff format checks on the source code."
...
lint: ruffcheck formatcheck apicheck configcheck readmecheck
